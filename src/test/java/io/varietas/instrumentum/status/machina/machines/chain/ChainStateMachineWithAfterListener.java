...
import io.varietas.instrumentum.status.machina.listeners.SimpleChainAfterListener;
...
@ChainListener(SimpleChainAfterListener.class)
public class ChainStateMachineWithAfterListener extends BasicChainStateMachine {

    public ChainStateMachineWithAfterListener(FSMConfiguration configuration) {
        super(configuration);
    }
