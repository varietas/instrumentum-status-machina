...
public class DefaultCFSMConfiguration extends DefaultFSMConfiguration implements CFSMConfiguration {
     ...
     */
    public DefaultCFSMConfiguration andAddChain(@NonNull final ChainContainer container) {
     ...
     * @return The instance of this container for a fluent like usage.
     */
    public DefaultCFSMConfiguration andAddChains(final List<ChainContainer> containers) {
    ...
    @Override
    public DefaultCFSMConfiguration andAddTransitions(List<TransitionContainer> containers) {
        super.andAddTransitions(containers);
        return this;
    }

    @Override
    public DefaultCFSMConfiguration andAddTransition(TransitionContainer container) {
